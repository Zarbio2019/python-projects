...
#r = requests.get('https://www.timeanddate.com/weather/usa/san-francisco', header={})
#for scrapping sometimes is necessary add header
#c = r.content
#from pprint import pprint
#pprint(c) # print in a better format
...
#print(__name__) # get the name of the file from flask_app.py
if __name__ == "__main__": # initialize the class
                           # allow don't execute from external file like flask_app.py
